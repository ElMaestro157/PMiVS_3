package com.example.dmitry.animation;
...
public class MainActivity extends Activity implements OnClickListener {
    ...
    private Button startFrameAnim; private
    Button startTransformAnim; private
    Button cancelAnim; private ImageView
            animationView;
    @Override public void onCreate(Bundle savedInstanceState) {
        ...
        cancelAnim = (Button) findViewById(R.id.cancelAnimation); animationView =
    ...
    public void onClick(View v) { if
        ...
        animationView.setBackgroundResource(R.drawable.ic_launcher_background);
